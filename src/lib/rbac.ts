...
export const DEFAULT_PERM_ROWS: PermRow[] = [
  ...
  { module: "مركز التقارير", moduleEn: "Reports Center", action: "فتح المركز", actionEn: "View Center",
    perms: { admin: "Y", manager: "Y", supervisor: "Y", technician: "N", insurance: "Y", accountant: "Y" } },
  { module: "مركز التقارير", moduleEn: "Reports Center", action: "تقارير التأمين", actionEn: "Insurance Reports",
    perms: { admin: "Y", manager: "Y", supervisor: "N", technician: "N", insurance: "Y", accountant: "Y" } },
  { module: "مركز التقارير", moduleEn: "Reports Center", action: "تقارير الكاش", actionEn: "Cash Reports",
    perms: { admin: "Y", manager: "Y", supervisor: "N", technician: "N", insurance: "N", accountant: "Y" } },
  { module: "مركز التقارير", moduleEn: "Reports Center", action: "التقارير المحاسبية", actionEn: "Accounting Reports",
    perms: { admin: "Y", manager: "Y", supervisor: "N", technician: "N", insurance: "N", accountant: "Y" } },
  { module: "مركز التقارير", moduleEn: "Reports Center", action: "تقارير الربحية", actionEn: "Profitability Reports",
    perms: { admin: "Y", manager: "Y", supervisor: "N", technician: "N", insurance: "N", accountant: "Y" } },
  { module: "مركز التقارير", moduleEn: "Reports Center", action: "تقارير المصروفات", actionEn: "Expense Reports",
    perms: { admin: "Y", manager: "Y", supervisor: "N", technician: "N", insurance: "N", accountant: "Y" } },
  { module: "مركز التقارير", moduleEn: "Reports Center", action: "تقارير التشغيل", actionEn: "Operations Reports",
    perms: { admin: "Y", manager: "Y", supervisor: "Y", technician: "N", insurance: "Y", accountant: "N" } },
  { module: "مركز التقارير", moduleEn: "Reports Center", action: "تصدير Excel", actionEn: "Export Excel",
    perms: { admin: "Y", manager: "Y", supervisor: "N", technician: "N", insurance: "Y", accountant: "Y" } },
  { module: "مركز التقارير", moduleEn: "Reports Center", action: "تصدير PDF", actionEn: "Export PDF",
    perms: { admin: "Y", manager: "Y", supervisor: "N", technician: "N", insurance: "Y", accountant: "Y" } },
  { module: "مركز التقارير", moduleEn: "Reports Center", action: "طباعة", actionEn: "Print",
    perms: { admin: "Y", manager: "Y", supervisor: "N", technician: "N", insurance: "Y", accountant: "Y" } },
  { module: "مركز التقارير", moduleEn: "Reports Center", action: "العروض المحفوظة", actionEn: "Saved Views",
    perms: { admin: "Y", manager: "Y", supervisor: "Y", technician: "N", insurance: "Y", accountant: "Y" } },
  { module: "مركز التقارير", moduleEn: "Reports Center", action: "إدارة التقارير", actionEn: "Reports Administration",
...
const ROUTE_RULES: Array<{ match: (p: string) => boolean; rule: RouteRule }> = [
  ...
  { match: (p) => p.startsWith("/reports"), rule: { module: "Reports Center", action: "View Center" } },
