...
function renderInsuranceTaxInvoiceAlwafaReference(data: InsuranceTaxInvoiceData): string {
  ...
  const styles = `
    ...
    *{box-sizing:border-box}
    ...
    .mono,.money{font-family:'Inter','Noto Sans Arabic',sans-serif;font-variant-numeric:tabular-nums;direction:ltr;unicode-bidi:embed}
    .top{display:grid;grid-template-columns:55mm minmax(64mm,1fr) 58mm;gap:4mm;align-items:start;direction:ltr;margin-bottom:8mm;position:relative}
    ...
    .brand-center{grid-column:2;display:flex;flex-direction:column;align-items:center;justify-content:flex-start;text-align:center;min-height:37mm;direction:rtl;padding-top:0;min-width:0;overflow:visible}
    .logo-box{width:26mm;height:17mm;display:flex;align-items:flex-start;justify-content:center;margin-bottom:1.6mm}.logo-box img{max-width:26mm;max-height:17mm;object-fit:contain}.brand-fallback{width:16mm;height:17mm;background:#071b39;border:.8mm solid #d8a01d;color:#d8a01d;display:flex;align-items:end;justify-content:center;padding-bottom:1.5mm;font-family:'Inter',sans-serif;font-size:8px;font-weight:800}
    .brand-name-ar{font-size:7.6px;font-weight:800;line-height:1.42;color:#071b39;width:100%;max-width:64mm;margin:0 0 .6mm;white-space:nowrap;overflow:visible;text-overflow:clip}
    ...
    .summary-row{display:grid;grid-template-columns:100mm 1fr;gap:17mm;align-items:center;margin-bottom:6mm;break-inside:avoid;page-break-inside:avoid;direction:ltr}.totals{border:1px solid #112b50;border-radius:1.5mm;padding:4mm 5mm}.total-line{display:grid;grid-template-columns:20mm 28mm 1fr;gap:3mm;align-items:center;padding:2mm 0}.total-line .cur{font-family:'Inter',sans-serif;font-weight:800}.total-line .amount{font-family:'Inter',sans-serif;font-weight:800;font-size:12px}.total-line .lbl{text-align:right;font-weight:700;line-height:1.35}.separator{height:1px;background:#071b39;margin:2mm 0 3mm}.payable{background:linear-gradient(135deg,#061a32,#082b4b);color:#fff!important;border-radius:1.4mm;padding:4mm 5mm;display:grid;grid-template-columns:1fr 42mm;align-items:center}.payable .amount{font-family:'Inter',sans-serif;font-size:22px;font-weight:800;text-align:left;color:#fff!important}.payable .label{text-align:right;font-weight:800;font-size:12px;line-height:1.5;color:#fff!important}.payable .label .label-en{color:#fff!important;word-spacing:1.8px;letter-spacing:.12px}.payable .currency{font-size:9px;margin-inline-start:2mm;color:#fff!important}
    ...
    .signature-row{display:grid;grid-template-columns:1fr 1fr;gap:20mm;align-items:end;margin:0 8mm 5mm;direction:ltr;break-inside:avoid;page-break-inside:avoid}.sig-box{text-align:left}.stamp-box{text-align:center}.sig-title,.stamp-title{font-size:10px;font-weight:700;color:#071b39;margin-bottom:4mm;line-height:1.45}.sig-line{height:16mm;border-bottom:1px solid #071b39;display:flex;align-items:end;justify-content:center}.sig-line img{max-width:47mm;max-height:14mm;object-fit:contain}.stamp-frame{height:16mm;border:1px dashed #9db0c8;border-radius:1.5mm;display:flex;align-items:center;justify-content:center;max-width:43mm;margin:0 auto}.stamp-frame img{max-width:40mm;max-height:14mm;object-fit:contain}
    .footer{border-top:1.2px solid #d8a01d;text-align:center;padding-top:2.5mm;font-size:10px;font-family:'Inter','Noto Sans Arabic',sans-serif;letter-spacing:.4px;color:#071b39;break-inside:avoid;page-break-inside:avoid;margin-bottom:0}.thanks{display:inline-flex;gap:13mm;align-items:center;justify-content:center}
