...
function renderInsuranceTaxInvoiceAlwafaReference(data: InsuranceTaxInvoiceData): string {
  ...
  const styles = `
    ...
    *{box-sizing:border-box}
    ...
    body{font-family:'Noto Sans Arabic','Inter','Segoe UI',Tahoma,sans-serif;font-size:10px}
    .page{width:210mm;height:297mm;max-height:297mm;margin:0 auto;padding:6mm 7mm 8mm;background:#fff;position:relative;overflow:hidden}
    .mono,.money{font-family:'Inter','Noto Sans Arabic',sans-serif;font-variant-numeric:tabular-nums;direction:ltr;unicode-bidi:embed}
    .top{display:grid;grid-template-columns:52mm minmax(64mm,1fr) 58mm;gap:4mm;align-items:start;direction:ltr;margin-bottom:5mm;position:relative}
    .invoice-card{width:52mm;background:linear-gradient(135deg,#061a32,#082b4b);color:#fff;border-radius:1.5mm;text-align:center;padding:5mm 4mm 4mm;box-shadow:0 2px 7px rgba(5,24,45,.18)}
    .invoice-card .ar{font-size:12px;font-weight:800;margin-bottom:1.4mm}.invoice-card .en{font-family:'Inter',sans-serif;font-size:8.8px;font-weight:800;letter-spacing:.5px;margin-bottom:2mm}.invoice-card .no{font-family:'Inter',sans-serif;font-size:22px;font-weight:800;line-height:1;letter-spacing:1px}
    .invoice-date{width:52mm;text-align:center;margin-top:2mm;color:#10213c;font-family:'Inter',sans-serif;font-size:9.5px}
