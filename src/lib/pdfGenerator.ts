...
function renderInsuranceTaxInvoiceAlwafaReference(data: InsuranceTaxInvoiceData): string {
  ...
  const styles = `
    ...
    *{box-sizing:border-box}
    ...
    .brand-name-en{font-family:'Inter',sans-serif;font-size:7.4px;font-weight:800;line-height:1.42;color:#071b39;width:100%;max-width:64mm;direction:ltr;white-space:nowrap;overflow:visible;text-overflow:clip}
  ...
  const body = `<div class="page">
    <header class="top">
      ...
      <div class="brand-center"><div class="logo-box">${logoHtml}</div><div class="brand-name-ar">${invoiceRefEscape(companyNameAr)}</div><div class="brand-name-en">${invoiceRefEscape(companyNameEn)}</div></div>
