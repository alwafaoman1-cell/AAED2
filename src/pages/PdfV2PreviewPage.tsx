...
async function loadWorkOrder(id: string): Promise<LoadedPdf> {
  ...
  const html = getWorkOrderHtml({
    ...
    vehicleType: (veh as any)?.brand || jo.vehicle_make || "—",
    ...
    workItems: Array.isArray(jo.work_items) ? jo.work_items : [],
    partsNeeded: Array.isArray(jo.parts_needed) ? jo.parts_needed : [],
