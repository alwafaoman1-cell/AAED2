...
begin
  ...
  return jsonb_build_object(
    ...
    'basis','period activity by invoice/payment/expense date; direct vehicle costs are lifetime per operation; invoice subtotal excludes VAT; monthly overhead is not allocated to vehicles',
    'generatedAt',now()
  );
end;
$$;
